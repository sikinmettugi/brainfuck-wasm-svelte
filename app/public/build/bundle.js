...
(function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 17, 4, 574);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 15, 0, 512);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<BfProgramInputBox> was created with unknown prop '${key}'`);
    	});
    ...
    class BfProgramInputBox extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*isRunning*/ ctx[1] === undefined && !("isRunning" in props)) {
    			console_1.warn("<BfProgramInputBox> was created without expected prop 'isRunning'");
    		}

    		if (/*curIndex*/ ctx[3] === undefined && !("curIndex" in props)) {
    			console_1.warn("<BfProgramInputBox> was created without expected prop 'curIndex'");
    		}
    	}
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 151, 12, 4609);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			add_location(button, file$2, 160, 24, 4918);
    			attr_dev(li, "class", "svelte-wkoo8r");
    			add_location(li, file$2, 159, 20, 4888);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(159:16) {#each presets as ps}",
    		ctx
    	});
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<BfInterface> was created with unknown prop '${key}'`);
    	});
    ...
    class BfInterface extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*state*/ ctx[13] === undefined && !("state" in props)) {
    			console_1$1.warn("<BfInterface> was created without expected prop 'state'");
    		}

    		if (/*program*/ ctx[14] === undefined && !("program" in props)) {
    			console_1$1.warn("<BfInterface> was created without expected prop 'program'");
    		}

    		if (/*newState*/ ctx[15] === undefined && !("newState" in props)) {
    			console_1$1.warn("<BfInterface> was created without expected prop 'newState'");
    		}

    		if (/*presets*/ ctx[0] === undefined && !("presets" in props)) {
    			console_1$1.warn("<BfInterface> was created without expected prop 'presets'");
    		}
    	}
